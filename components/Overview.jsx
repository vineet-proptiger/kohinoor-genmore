...
const PREVIEW_TEXT = `Kohinoor Gen-More (Codename Downtown 2.0) is a premium new launch residential project by Kohinoor Group, located in the thriving locality of Wakad, Pune. RERA registered as Kohinoor Anantara (RERA No. PR1260002501984), this project presents luxurious 2 BHK and 3 BHK apartments with carpet areas ranging from 700 to 1100 Sq.Ft. The residences are thoughtfully designed with modern layouts, premium fittings, and superior finishes to ensure an elevated lifestyle for discerning homebuyers.`;

const MORE_PARAS = [
  `Strategically situated in Wakad, residents enjoy seamless connectivity to major IT hubs of Hinjewadi, the Mumbai-Pune Expressway, top schools, hospitals, and premier retail destinations — making it an ideal address for working professionals and families alike.`,
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-stretch">
          ...
          <div data-aos="fade-right" style={{ display: "flex" }}>
            ...
            >
              <Image
                src={overviewImage}
                alt="Kohinoor Gen-More Wakad Pune"
                fill

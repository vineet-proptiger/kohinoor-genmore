...
const plans = [
  ...
  { label: '2 BHK', img: masterplanImages.bhk3 },
  { label: '3 BHK', img: masterplanImages.bhk45 },
]
                ...
                <button key={idx} onClick={() => setActivePlan(idx)}
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '2px' }}>
                      ...
                      {plan.carpet && (
                        <span style={{
                          fontSize: '11px', fontWeight: '600', fontFamily: F_SANS,
                          color: activePlan === idx ? 'var(--color-teal-dark)' : '#9ca3af',
                          transition: 'color 0.2s',
                        }}>Carpet Area : {plan.carpet}</span>
                      )}
                    </div>
                  </div>
                  {/* Arrow */}

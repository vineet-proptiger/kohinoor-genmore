            ...
            >
              {slides.map((src, idx) => (
                ...
                >
                  <Image
                    src={src}
                    alt={`Kohinoor Gen-More Wakad Pune ${idx + 1}`}
                    fill
          ...
          <div className="p-4 flex flex-col gap-3">
            ...
            >
              ...
              <p
                ...
                data-aos-delay="280"
              >
                At Wakad (close to Hinjewadi), Pune
              </p>
              {/* <p
                style={{
                  fontFamily: F_SANS,
            ...
            >
              {[
                { value: "3", label: "Acres" },
                { value: "2 & 3 BHK", label: "Apartments" },
                { value: "50+", label: "World-class Amenities" },
                { value: "Wakad", label: "Location, Pune" },
              ].map((s, i) => (
                <div
                  key={i}
                  style={{
            ...
            >
              ...
              >
                Wakad&apos;s Most Awaited Address
              </p>
              {[
                "Additional Spot Booking Discounts",
                "Book Now & Get Early Bird Discounts",
                "Exclusive Flexi Payment Plans",
              ].map((item, i, arr) => (
                <div key={i}>
                  <p
                    style={{

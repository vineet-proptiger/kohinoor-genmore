      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-stretch max-w-6xl mx-auto">
        ...
        >
          ...
          >
            ...
            >
              Founded in 1985, Kohinoor Group is one of Pune&apos;s most
              trusted real estate developers, known for delivering high-quality
              residential and commercial projects across prime locations. With a
              portfolio spanning across Pune, the group has earned a strong
              reputation for timely delivery, architectural excellence, and
            ...
            >
              {[
                ...
                { value: "25000+", label: "Happy Families" },
              ].map((stat, i) => (
                <div
                  key={i}
                  style={{
